/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-navigation-1.6.5/debian/ros-electric-navigation/opt/ros/electric/stacks/navigation/move_base_msgs/msg/MoveBaseActionFeedback.msg */
...
struct MoveBaseActionFeedback_ {
  ...
  typedef  ::move_base_msgs::MoveBaseFeedback_<ContainerAllocator>  _feedback_type;
   ::move_base_msgs::MoveBaseFeedback_<ContainerAllocator>  feedback;


private:
  static const char* __s_getDataType_() { return "move_base_msgs/MoveBaseActionFeedback"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "7d1870ff6e0decea702b943b5af0b42e"; }
public:
...
{
template<class ContainerAllocator> struct IsMessage< ::move_base_msgs::MoveBaseActionFeedback_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::move_base_msgs::MoveBaseActionFeedback_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::move_base_msgs::MoveBaseActionFeedback_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::move_base_msgs::MoveBaseActionFeedback_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
