/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-navigation-1.6.5/debian/ros-electric-navigation/opt/ros/electric/stacks/navigation/move_base_msgs/msg/MoveBaseAction.msg */
...
private:
  static const char* __s_getDataType_() { return "move_base_msgs/MoveBaseAction"; }
public:
...
{
template<class ContainerAllocator> struct IsMessage< ::move_base_msgs::MoveBaseAction_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::move_base_msgs::MoveBaseAction_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
