"""autogenerated by genmsg_py from MoveBaseActionResult.msg. Do not edit."""
...
class MoveBaseActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','move_base_msgs/MoveBaseResult']
