"""autogenerated by genmsg_py from MoveBaseActionFeedback.msg. Do not edit."""
...
class MoveBaseActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','move_base_msgs/MoveBaseFeedback']
