"""autogenerated by genmsg_py from MakeNavPlanRequest.msg. Do not edit."""
...
class MakeNavPlanRequest(roslib.message.Message):
...
"""autogenerated by genmsg_py from MakeNavPlanResponse.msg. Do not edit."""
import roslib.message
import struct
...
class MakeNavPlanResponse(roslib.message.Message):
...
class MakeNavPlan(roslib.message.ServiceDefinition):
