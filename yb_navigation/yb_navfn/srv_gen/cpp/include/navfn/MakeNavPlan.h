/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-navigation-1.6.5/debian/ros-electric-navigation/opt/ros/electric/stacks/navigation/navfn/srv/MakeNavPlan.srv */
...
struct MakeNavPlanResponse_ {
  ...
  ROS_DEPRECATED uint32_t get_path_size() const { return (uint32_t)path.size(); }
  ROS_DEPRECATED void set_path_size(uint32_t size) { path.resize((size_t)size); }
  ROS_DEPRECATED void get_path_vec(std::vector< ::geometry_msgs::PoseStamped_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::other > & vec) const { vec = this->path; }
  ROS_DEPRECATED void set_path_vec(const std::vector< ::geometry_msgs::PoseStamped_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::other > & vec) { this->path = vec; }
private:
...
{
template<class ContainerAllocator> struct IsMessage< ::navfn::MakeNavPlanRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::navfn::MakeNavPlanRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::navfn::MakeNavPlanResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::navfn::MakeNavPlanResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
